@extends('superadmin.admin-template')
@section('css')
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        ...
                        <div class="bs-component">
                          <div class="jumbotron">
                            <h1>Hai.. </h1>
                            <p> bagaimana kabar semuanya? Tanpa terasa kita sudah memasuki bulan Maret ya, yang berarti semester satu sudah mendekati titik akhir. Nah, ini berarti bisa menjadi waktu yang tepat untuk kita bersama lebih mengenali kurikulum atau kerangka pelajaran yang kita gunakan.</p>
                          </div>
                        </div>
                      </div>
                    </div>
