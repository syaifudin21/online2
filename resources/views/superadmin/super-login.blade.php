    ...
    <div class="content">
        ...
        <form action="{{route('superadmin.login')}}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="username" type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}{{(env('APP_ENV')== 'development')? 'superadmin': ''}}" required autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{(env('APP_ENV')== 'development')? '121212': ''}}" required autofocus>
