...
<main class="app-content">
    ...
    <div class="row">
            <div class="col-md-8">
                <div class="tile">
                  <div class="tile-body">
                    <form class="form-horizontal" id="submit-form" method="post" action="{{route('superadmin.admin.store')}}">
                        {{ csrf_field() }}

                      <div class="form-group row">
                        <label class="control-label col-md-4" for="nama">Nama</label>
                        <div class="col-md-7">
                            <input class="form-control {{ $errors->has('nama') ? ' is-invalid' : '' }}" type="text" name="nama" placeholder="Nama" value="{{old('nama')}}" aria-describedby="nama" id="nama">
                            @if ($errors->has('nama'))
                        ...
                        <div class="col-md-7">
                            <input class="form-control {{ $errors->has('username') ? ' is-invalid' : '' }}" type="text" name="username" placeholder="username" value="{{old('username')}}" aria-describedby="username" id="username">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                            <div class="form-check">
                                              <input class="form-check-input" type="checkbox" name="akses[]" id="kelas" value="827980">
                                              <label class="form-check-label" for="kelas">
                                                Kelas
                                              </label>
                                            </div>
                                            <div class="form-check">
                                              <input class="form-check-input" type="checkbox" name="akses[]" id="agenda" value="981987">
                                              <label class="form-check-label" for="agenda">
                                                Agenda
                                              </label>
                                            </div>
                                            <div class="form-check">
                                              <input class="form-check-input" type="checkbox" name="akses[]" id="bantuan" value="915879">
                                              <label class="form-check-label" for="bantuan">
                                                Bantuan
                                              </label>
                                            </div>
                                            <div class="form-check">
                                              <input class="form-check-input" type="checkbox" name="akses[]" id="pengajar" value="981098">
                                              <label class="form-check-label" for="pengajar">
                                                Pengajar / Guru
                                              </label>
                                            </div>
                                            <div class="form-check">
                                              <input class="form-check-input" type="checkbox" name="akses[]" id="prestasi" value="657842">
                                              <label class="form-check-label" for="prestasi">
                                                Prestasi
                                              </label>
                                            </div>
                                            <div class="form-check">
                                              <input class="form-check-input" type="checkbox" name="akses[]" id="masukan" value="912879">
                                              <label class="form-check-label" for="masukan">
                                                Masukkan
                                              </label>
                                            </div>
                                            <div class="form-check">
                                              <input class="form-check-input" type="checkbox" name="akses[]" id="forum" value="962879">
                                              <label class="form-check-label" for="forum">
                                                Forum
                                              </label>
                                            </div>
                                            <div class="form-check">
                                              <input class="form-check-input" type="checkbox" name="akses[]" id="perpustakaan" value="812788">
